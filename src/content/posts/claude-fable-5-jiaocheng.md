...
relatedTools: ["claude"]
faq:
  - q: "Claude Fable 5 和 Mythos 5 有什么区别？"
    a: "同一底座的两个版本：Mythos 5 能力拉满但仅向特定机构开放；Fable 5 是面向公众的版本，加了更严格的安全护栏。"
  - q: "Fable 5 为什么经常拒绝回答？"
    a: "安全分类器会拦截网络安全、生物化学、模型蒸馏等敏感话题，实测触发比官方宣称的 5% 更频繁，触发时会切到 Opus 4.8 代答或直接拒绝。"
  - q: "国内怎么用上 Fable 5？"
