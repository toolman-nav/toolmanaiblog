...
faq:
  ...
  - q: "Z.ai 和 Napkin AI 该怎么选？"
    a: "想从零生成整份 PPT 选 Z.ai，一句话即可产出并支持在线编辑；数据图表要求高选 Napkin AI，可把文字一键转成咨询级信息图。"
  - q: "生成的 PPT 可以导出哪些格式？"
    a: "Z.ai 和 Kimi 支持导出可编辑的 PPT 文件；Napkin AI 支持导出 PPT、PDF、PNG、SVG 等多种格式。"
---
又到年底了，还在为做PPT熬夜肝到头秃？
