...
faq:
  - q: "国内使用 NotebookLM 需要准备什么？"
    a: "需要可用的网络环境、一个谷歌账号和你要整理的资料；打开 notebooklm.google.com 登录即可使用，目前免费。"
  - q: "NotebookLM 和普通 AI 聊天有什么区别？"
    a: "它基于 RAG 技术，只根据你上传的资料回答、不会凭空编造，适合总结长文档、生成播客音频和会议纪要。"
  - q: "免费版有什么限制？"
    a: "每个笔记本最多添加 50 个来源，支持 PDF、文档、音频、网页和 YouTube 链接，日常学习和办公足够用。"
---
还在为开会时手忙脚乱的笔记发愁？
