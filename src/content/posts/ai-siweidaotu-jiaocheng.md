...
faq:
  ...
  - q: "不会编程能用 Markdown 方案吗？"
    a: "可以。让 AI 按提示词输出带 # 层级的 Markdown，粘贴到 markmap.js.org/repl 就能自动渲染成可交互导图，或导入 XMind，全程不用写代码。"
  - q: "AI 生成的导图内容可靠吗？"
    a: "需要人工把关。AI 可能出现逻辑幻觉，生成后花几分钟核对大标题和核心逻辑，并在提示词里要求突出你关注的重点。"
---
...
![AI 生成的 Markdown 层级大纲](../../assets/images/ai-siweidaotu-jiaocheng/01.webp)
...
![Markmap 将 Markdown 转成可交互思维导图](../../assets/images/ai-siweidaotu-jiaocheng/02.webp)
...
![XMind 导入 Markdown 后的思维导图](../../assets/images/ai-siweidaotu-jiaocheng/03.webp)
